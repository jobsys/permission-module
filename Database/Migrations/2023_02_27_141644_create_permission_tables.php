...
return new class extends Migration {
	...
	public function up()
	{
		...
		Schema::create($tableNames['permissions'], function (Blueprint $table) {
			...
			$table->integer('sort_order')->default(0)->comment('sort order, the bigger the number, the higher the sort order');
		...
		Schema::create($tableNames['roles'], function (Blueprint $table) use ($teams, $columnNames) {
			...
			$table->integer('sort_order')->default(0)->comment('sort order, the bigger the number, the higher the sort order');
			$table->boolean('is_active')->default(true)->comment('whether the permission is active');
			$table->boolean('is_inherent')->default(false)->comment('is the role deletable');
			$table->timestamps();
